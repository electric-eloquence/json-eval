...
', function () {
    ...
    it('should parse multiple unwrapped keys, containing backslashes, minus signs and tildes, with different amounts \
of spacing', function () {
    ...
    it('should parse multiple wrapped and unwrapped keys, containing colons, backslashes and minus signs, with \
unwrapped values 1st in the list', function () {
    ...
    it('should parse multiple wrapped and unwrapped keys, containing backslashes, colons and minus signs, with \
